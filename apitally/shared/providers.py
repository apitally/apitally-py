...
def create_metric_exporter(env: str, **kwargs: Any) -> OTLPMetricExporter:
    return OTLPMetricExporter(endpoint=endpoint_url("/v1/metrics"), headers=export_headers(env), **kwargs)
